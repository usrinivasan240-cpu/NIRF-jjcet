...
export default function NirfReportTemplate({
  ...
  const categories = [
    ...
    { name: "Events", target: 6, achieved: allStu.length > 0 ? Math.min(allStu.length, 6) : 0 },
  ];
      ...
      <table style={tableStyle}>
        <tbody>
          ...
          <tr>
            ...
            <td style={valueCellStyle}>{meta.hodName || config.hodName || "—"}</td>
          ...
          <tr>
            ...
            <td style={valueCellStyle}>{meta.facultyCount}</td>
            <td style={labelCellStyle}>Student Count</td>
            <td style={valueCellStyle}>{meta.studentCount}</td>
          </tr>
          <tr>
            <td style={labelCellStyle}>PhD Faculty</td>
            <td style={valueCellStyle}>{meta.phdCount}</td>
        ...
        <tbody>
          <tr>
            <td style={{ width: "33%", padding: "8px", border: "1px solid #cbd5e1", verticalAlign: "top" }}>
              ...
              <div style={{ minHeight: "50px", borderBottom: "1px dashed #999" }} />
            </td>
            <td style={{ width: "33%", padding: "8px", border: "1px solid #cbd5e1", verticalAlign: "top" }}>
        ...
        <tbody>
          <tr>
            <td style={{ width: "33%", padding: "10px", border: "1px solid #cbd5e1", textAlign: "center", verticalAlign: "top" }}>
              ...
              <p style={{ fontSize: "9px", fontWeight: "700", margin: "0" }}>Head of Department</p>
            ...
            <td style={{ width: "33%", padding: "10px", border: "1px solid #cbd5e1", textAlign: "center", verticalAlign: "top" }}>
              <div style={{ height: "40px", borderBottom: "1px solid #999", marginBottom: "4px" }} />
              <p style={{ fontSize: "9px", fontWeight: "700", margin: "4px 0 1px 0" }}>Signature</p>
              <p style={{ fontSize: "9px", fontWeight: "700", margin: "0" }}>Vice Principal</p>
              <p style={{ fontSize: "8px", color: "#666", margin: "2px 0 0 0" }}>Date: _______________</p>
              <p style={{ fontSize: "8px", color: "#666", margin: "2px 0 0 0" }}>Seal:</p>
            </td>
            <td style={{ width: "33%", padding: "10px", border: "1px solid #cbd5e1", textAlign: "center", verticalAlign: "top" }}>
              <div style={{ height: "40px", borderBottom: "1px solid #999", marginBottom: "4px" }} />
              <p style={{ fontSize: "9px", fontWeight: "700", margin: "4px 0 1px 0" }}>Signature</p>
              <p style={{ fontSize: "9px", fontWeight: "700", margin: "0" }}>Principal</p>
              <p style={{ fontSize: "8px", color: "#666", margin: "2px 0 0 0" }}>Date: _______________</p>
              <p style={{ fontSize: "8px", color: "#666", margin: "2px 0 0 0" }}>Seal:</p>
            </td>
          </tr>
